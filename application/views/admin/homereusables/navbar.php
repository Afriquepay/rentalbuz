                        ...
                        <ul>
                            <li>
                                <a href="#" class="clearfix">
                                    <figure class="image">
                                        <img src="<?=base_url();?>uploads/img/!sample-user.jpg" alt="Joseph Doe Junior" class="rounded-circle" />
                                    </figure>
                            ...
                            <li>
                                <a href="#" class="clearfix">
                                    <figure class="image">
                                        <img src="<?=base_url();?>uploads/img/!sample-user.jpg" alt="Joseph Junior" class="rounded-circle" />
                                    </figure>
                            ...
                            <li>
                                <a href="#" class="clearfix">
                                    <figure class="image">
                                        <img src="<?=base_url();?>uploads/img/!sample-user.jpg" alt="Joe Junior" class="rounded-circle" />
                                    </figure>
        ...
        <div id="userbox" class="userbox">
            <a href="#" data-bs-toggle="dropdown">
                <figure class="profile-picture">
                    <img src="<?=base_url()."/".$this->session->userdata('ppix') ;?>" alt="Joseph Doe" class="rounded-circle" data-lock-picture="img/!logged-user.jpg" />
                </figure>
                <div class="profile-info" data-lock-name="Afriquepay" data-lock-email="">
            ...
            <div class="dropdown-menu">
                <ul class="list-unstyled mb-2">
                    ...
                    <li>
                        <a role="menuitem" tabindex="-1" href="<?=base_url().'admin/logout'?>"><i class="bx bx-power-off"></i> Logout</a>
                    </li>
                </ul>
            </div>
        </div>
