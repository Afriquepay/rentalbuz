										...
										<table class="table table-bordered table-striped mb-0" id="datatable-tabletools">
											...
											foreach($all_user as $user){
												...
												<tr>
													...
													<td><img src="<?php echo base_url()."/".$user['profilepixurl'] ?>" alt="" class="img-responsive"></td>
													<td><?php echo $user['email'] ?></td>
													<td>&#8358;<?php echo $user['walletamount'] ?></td>
													<td><?php echo $user['refername'] ?></td>
													<td><?php echo $user['date'] ?></td>
													<td>
                                                        <a href="edit-user/<?php echo $user['id']; ?>"><i class="fa fa-edit"></i></a>
