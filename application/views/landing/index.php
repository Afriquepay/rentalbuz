...
<body>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-9 col-9">
                        <div class="partner-box partner-carousel">
                            <div class="single">
                                <div class="item">
                                    <img src="<?=base_url();?>uploads/assets/images/partner-1.png" alt="image">
                                </div>
                            </div>
                            <div class="single">
                                <div class="item">
                                    <img src="<?=base_url();?>uploads/assets/images/partner-2.png" alt="image">
                                </div>
                            </div>
                            <div class="single">
                                <div class="item">
                                    <img src="<?=base_url();?>uploads/assets/images/partner-3.png" alt="image">
                                </div>
                            </div>
                            <div class="single">
                                <div class="item">
                                    <img src="<?=base_url();?>uploads/assets/images/partner-4.png" alt="image">
                                </div>
                            </div>
                            <div class="single">
                                <div class="item">
                                    <img src="<?=base_url();?>uploads/assets/images/partner-5.png" alt="image">
                                </div>
                            </div>
                            <div class="single">
                                <div class="item">
    ...
    <div class="footer-section">
        ...
        <div class="img-area">
            <img src="<?=base_url();?>uploads/assets/images/footer-Illu-left.png" class="left" alt="Images">
            <img src="<?=base_url();?>uploads/assets/images/footer-Illu-right.png" class="right" alt="Images">
        </div>
    </div>
    <!-- Footer Area End -->
