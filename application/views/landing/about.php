            ...
            <div class="container wow fadeInUp">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 text-end">
                        <div class="img-area">
                            <img class="img-1" src="<?=base_url();?>uploads/assets/images/about-img-1.png" alt="image">
                            <img class="img-2" src="<?=base_url();?>uploads/assets/images/about-img-2.png" alt="image">
                            <img class="img-3" src="<?=base_url();?>uploads/assets/images/about-img-3.png" alt="image">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row cus-mar">
                    <div class="col-xl-4 col-md-4">
                        <div class="single-box">
                            <div class="icon">
                                <img src="<?=base_url();?>uploads/assets/images/icon/core-values-1.png" alt="icon">
                            </div>
                            <div class="text-area">
                    ...
                    <div class="col-xl-4 col-md-4">
                        <div class="single-box">
                            <div class="icon">
                                <img src="<?=base_url();?>uploads/assets/images/icon/core-values-2.png" alt="icon">
                            </div>
                            <div class="text-area">
                    ...
                    <div class="col-xl-4 col-md-4">
                        <div class="single-box">
                            <div class="icon">
                                <img src="<?=base_url();?>uploads/assets/images/icon/core-values-3.png" alt="icon">
                            </div>
                            <div class="text-area">
                                <h5>Commitment</h5>
    ...
    <section class="map-section">
        <div class="overlay pt-120 pb-120">
            <div class="container wow fadeInUp">
                ...
                <div class="row">
                    <div class="map-area">
                        <img src="<?=base_url();?>uploads/assets/images/world-map.png" alt="image">
                        <div class="element pos-1">
                            <div class="details">
                                <p>2715 Ash Dr. San Jose, South Dakota 83475</p>
                            </div>
                            <div class="dot-area">
                                <img src="<?=base_url();?>uploads/assets/images/icon/maps-dot.png" alt="image">
                            </div>
                        </div>
                    ...
                    <div class="journey-carousel">
                        <div class="single">
                            <div class="single-box">
                                <div class="top-box d-flex align-items-center">
                                    <div class="icon-box">
                                        <img src="<?=base_url();?>uploads/assets/images/icon/our-journey-1.png" alt="icon">
                                    </div>
                                    <h4>2016</h4>
                                </div>
                                <div class="text-box">
                        ...
                        <div class="single">
                            <div class="single-box">
                                <div class="top-box d-flex align-items-center">
                                    <div class="icon-box">
                                        <img src="<?=base_url();?>uploads/assets/images/icon/our-journey-2.png" alt="icon">
                                    </div>
                                    <h4>2017</h4>
                                </div>
                                <div class="text-box">
                        ...
                        <div class="single">
                            <div class="single-box">
                                <div class="top-box d-flex align-items-center">
                                    <div class="icon-box">
                                        <img src="<?=base_url();?>uploads/assets/images/icon/our-journey-3.png" alt="icon">
                                    </div>
                                    <h4>2018</h4>
                                </div>
                                <div class="text-box">
                        ...
                        <div class="single">
                            <div class="single-box">
                                <div class="top-box d-flex align-items-center">
                                    <div class="icon-box">
                                        <img src="<?=base_url();?>uploads/assets/images/icon/our-journey-4.png" alt="icon">
                                    </div>
                                    <h4>2019</h4>
                                </div>
                                <div class="text-box">
                            ...
                            <div class="tab-pane fade show active" id="board" role="tabpanel" aria-labelledby="board-tab">
                                <div class="row">
                                    <div class="col-md-3 col-sm-6">
                                        <div class="single-box">
                                            <div class="icon-box">
                                                <img src="<?=base_url();?>uploads/assets/images/team-2.png" alt="image">
                                            </div>
                                            <div class="test-area">
                                                <h5>Dale Bryant</h5>
                                                <p>CEO & Founder</p>
                                    ...
                                    <div class="col-md-3 col-sm-6">
                                        <div class="single-box">
                                            <div class="icon-box">
                                                <img src="<?=base_url();?>uploads/assets/images/team-1.png" alt="image">
                                            </div>
                                            <div class="test-area">
                                                <h5>Dale Bryant</h5>
                                                <p>CEO & Founder</p>
                                    ...
                                    <div class="col-md-3 col-sm-6">
                                        <div class="single-box">
                                            <div class="icon-box">
                                                <img src="<?=base_url();?>uploads/assets/images/team-3.png" alt="image">
                                            </div>
                                            <div class="test-area">
                                                <h5>Dale Bryant</h5>
                                                <p>CEO & Founder</p>
                                    ...
                                    <div class="col-md-3 col-sm-6">
                                        <div class="single-box">
                                            <div class="icon-box">
                                                <img src="<?=base_url();?>uploads/assets/images/team-4.png" alt="image">
                                            </div>
                                            <div class="test-area">
                                                <h5>Dale Bryant</h5>
                                                <p>CEO & Founder</p>
                                    ...
                                    <div class="col-md-3 col-sm-6">
                                        <div class="single-box">
                                            <div class="icon-box">
                                                <img src="<?=base_url();?>uploads/assets/images/team-5.png" alt="image">
                                            </div>
                                            <div class="test-area">
                                                <h5>Dale Bryant</h5>
                                                <p>CEO & Founder</p>
                                    ...
                                    <div class="col-md-3 col-sm-6">
                                        <div class="single-box">
                                            <div class="icon-box">
                                                <img src="<?=base_url();?>uploads/assets/images/team-6.png" alt="image">
                                            </div>
                                            <div class="test-area">
                                                <h5>Dale Bryant</h5>
                                                <p>CEO & Founder</p>
                                    ...
                                    <div class="col-md-3 col-sm-6">
                                        <div class="single-box">
                                            <div class="icon-box">
                                                <img src="<?=base_url();?>uploads/assets/images/team-7.png" alt="image">
                                            </div>
                                            <div class="test-area">
                                                <h5>Dale Bryant</h5>
                                                <p>CEO & Founder</p>
                                    ...
                                    <div class="col-md-3 col-sm-6">
                                        <div class="single-box">
                                            <div class="icon-box">
                                                <img src="<?=base_url();?>uploads/assets/images/team-8.png" alt="image">
                                            </div>
                                            <div class="test-area">
                                                <h5>Dale Bryant</h5>
                                                <p>CEO & Founder</p>
