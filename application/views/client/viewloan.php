                                        ...
                                        <form action="" id="loanform"  data-persist="garlic">
                                            ...
                                            <div class="form-group row pb-2">
                                             ...
                                             <div class="form-group row pb-2">
												...
												<div class="col-lg-8">
													<input type="text" class="form-control" id="amount"  name="amount" value="<?php echo $loan_lists[0]['amount'];?>" required placeholder="NGN" readonly>
												</div>
											</div>
                                            <!-- form list -->
                                            <div class="form-group row pb-2">
												...
												<div class="col-lg-8">
													<textarea class="form-control"  id="inputDefault"  name="description"   required readonly><?php echo $loan_lists[0]['loan_purpose'];?></textarea>
												</div>
											</div>
                                            ...
                                            <div class="form-group row pb-2 mt-2">
												...
												<div class="col-lg-8">
													<select  class="form-control" id="inputDefault" name="duration" required readonly>
                                                        <option value="1" <?php echo $loan_lists[0]['duration']==1 ? "selected" : "" ?>>1</option>
                                                        <option value="2" <?php echo $loan_lists[0]['duration']==2 ? "selected" : "" ?>>2</option>
                                                        <option value="3" <?php echo $loan_lists[0]['duration']==3 ? "selected" : "" ?>>3</option>
                                                        <option value="4" <?php echo $loan_lists[0]['duration']==4 ? "selected" : "" ?>>4</option>
                                                        <option value="5" <?php echo $loan_lists[0]['duration']==5 ? "selected" : "" ?>>5</option>
                                                        <option value="6" <?php echo $loan_lists[0]['duration']==6 ? "selected" : "" ?>>6</option>
                                                        <option value="7" <?php echo $loan_lists[0]['duration']==7 ? "selected" : "" ?>>7</option>
                                                        <option value="8" <?php echo $loan_lists[0]['duration']==8 ? "selected" : "" ?>>8</option>
                                                        <option value="9" <?php echo $loan_lists[0]['duration']==9 ? "selected" : "" ?>>9</option>
                                                    </select>
												</div>
											</div>
                                            <div class="form-group row pb-2 mt-1">
												...
												<div class="col-lg-8">
													<select  class="form-control" id="inputDefault" name="repayment_schedule" required readonly>
                                                        <option value="Daily" <?php echo $loan_lists[0]['repayment_schedule']=="Daily" ? "selected" : "" ?>>Daily</option>
                                                        <option value="Weekly" <?php echo $loan_lists[0]['repayment_schedule']=="Weekly" ? "selected" : "" ?>>Weekly</option>
                                                        <option value="Monthly" <?php echo $loan_lists[0]['repayment_schedule']=="Monthly" ? "selected" : "" ?>>Montly</option>
                                            ...
                                            <div class="form-group row pb-2 mt-1">
												...
												<div class="col-lg-8">
													<select  class="form-control" id="inputDefault" name="loan_type" required readonly>
                                                        <option value="1" <?php echo $loan_lists[0]['loan_type']==1 ? "selected" : "" ?>>Flat</option>
                                                        <option value="2" <?php echo $loan_lists[0]['loan_type']==2 ? "selected" : "" ?>>Reducing Balance</option>
                                            ...
                                            <div class="form-group row pb-2 mt-2">
												...
												<div class="col-lg-8">
													<textarea class="form-control" id="inputDefault" name="apartment_description" placeholder="This includes the better address and the look of the apartment" required readonly><?php echo $loan_lists[0]['apartment_description'];?></textarea>
												</div>
											</div>
                                            <div class="form-group row pb-2 mt-2">
												<label class="col-lg-3 control-label text-lg-end pt-2" for="inputDefault" style="font-weight:bold">State</label>
												<div class="col-lg-8">
													<select  class="form-control" name="state_id" id="state" required readonly>
                                                        <?php
                                                        foreach($states as $state){?>

                                                        <option value="<?php echo $state['id'];?>" <?php echo $loan_lists[0]['state_id']== $state['id'] ? "selected" : "" ?>><?php echo $state['name'];?></option>
                                            ...
                                            <div class="form-group row pb-2 mt-2">
												...
												<div class="col-lg-8">
													<select  class="form-control" id="lga" name="lga_id" required readonly>
                                                    <?php
                                                        foreach($lgas as $lga){?>

                                                        <option value="<?php echo $lga['id'];?>" <?php echo $loan_lists[0]['lga_id']== $lga['id'] ? "selected" : "" ?>><?php echo $lga['name'];?></option>
                                            ...
                                            <div class="form-group row pb-2">
												...
												<div class="col-lg-8">
													<input type="text" class="form-control" id="inputDefault" name="owners_name" value="<?php echo $loan_lists[0]['owners_name'];?>" required readonly>
												</div>
											</div>
                                            <div class="form-group row pb-2">
												<label class="col-lg-3 control-label text-lg-end pt-2" for="inputDefault" style="font-weight:bold">Owner's Phone</label>
												<div class="col-lg-8">
													<input type="text" class="form-control" id="inputDefault" name="owners_phone" value="<?php echo $loan_lists[0]['owners_name'];?>"  required readonly>
												</div>
											</div>
                                            ...
                                            <div class="col-lg-12 mt-2">
                                             ...
                                             <div class="form-group row pt-2">
												...
												<div class="col-lg-8">
                                                    <button class="btn btn-primary" type="button" id="btng1" style="display:none">Choose Image</button>
													<input type="file" class="form-control" id="guarantorimginput1" name="guarantor1_image" style="display:none" required>
												</div>
                                                <div class="col-lg-3 text-lg-end ">
                                                    <img src="<?php echo base_url().$loan_lists[0]['guarantor1_image'];?>" id="guarantorimgdisplay1"  alt="" width="140px" height="140px">
                                            ...
                                            <div class="form-group row pb-2">
												...
												<div class="col-lg-8">
													<input type="text" class="form-control" id="inputDefault" name="guarantor1_relationship" value="<?php echo $loan_lists[0]['guarantor1_relationship'];?>" required readonly>
												</div>
											</div>
                                            <div class="form-group row pb-2">
												<label class="col-lg-3 control-label text-lg-end pt-2" for="inputDefault" style="font-weight:bold">Guarantor's Name</label>
												<div class="col-lg-8">
													<input type="text" class="form-control" id="inputDefault" name="guarantor1_name" required value="<?php echo $loan_lists[0]['guarantor1_name'];?>" readonly>
												</div>
											</div>
                                            <div class="form-group row pb-2">
												...
												<div class="col-lg-8">
													<input type="text" class="form-control" id="inputDefault" name="guarantor1_phone" value="<?php echo $loan_lists[0]['guarantor1_phone'];?>" required readonly>
												</div>
											</div>
                                             <!-- form list -->
                                             <div class="form-group row pb-2">
												...
												<div class="col-lg-8">
													<textarea class="form-control" id="inputDefault" name="guarantor1_address" required readonly><?php echo $loan_lists[0]['guarantor1_address'];?></textarea>
												</div>
											</div>
                                            ...
                                            <h3>Guarantor 2</h3>
                                             ...
                                             <div class="form-group row pt-2">
                                                ...
                                                <div class="col-lg-3 text-lg-end ">
                                                    ...
                                                    <img src="<?php echo base_url().$loan_lists[0]['guarantor2_image'];?>" id="guarantorimgdisplay2"  alt="" width="140px" height="140px">
                                            ...
                                            <div class="form-group row pb-2">
												<label class="col-lg-3 control-label text-lg-end pt-2" for="inputDefault" style="font-weight:bold">Relationship</label>
												<div class="col-lg-8">
													<input type="text" class="form-control" id="inputDefault" name="guarantor2_relationship" value="<?php echo $loan_lists[0]['guarantor2_relationship'];?>" required readonly>
												</div>
											</div>
                                            <div class="form-group row pb-2">
												<label class="col-lg-3 control-label text-lg-end pt-2" for="inputDefault" style="font-weight:bold">Guarantor's Name</label>
												<div class="col-lg-8">
													<input type="text" class="form-control" id="inputDefault" name="guarantor2_name" value="<?php echo $loan_lists[0]['guarantor2_name'];?>" readonly required>
												</div>
											</div>
                                            <div class="form-group row pb-2">
												<label class="col-lg-3 control-label text-lg-end pt-2" for="inputDefault" style="font-weight:bold">Guarantor's Phone Number</label>
												<div class="col-lg-8">
													<input type="text" class="form-control" id="inputDefault" name="guarantor2_phone" value="<?php echo $loan_lists[0]['guarantor2_phone'];?>" required readonly>
												</div>
											</div>
                                             <!-- form list -->
                                             <div class="form-group row pb-2">
												<label class="col-lg-3 control-label text-lg-end pt-2" for="inputDefault" style="font-weight:bold">Guarantor's Address</label>
												<div class="col-lg-8">
													<textarea class="form-control" id="inputDefault" name="guarantor_address"  required readonly><?php echo $loan_lists[0]['guarantor1_address'];?></textarea>
												</div>
											</div>
                                            <!-- <button class="btn btn-primary block" type="submit" id="crtbtn">Edit</button> -->
